    ...
    def _get_fallback_labels(self, lang_code: str) -> dict:
        ...
        labels = {
            ...
            "id": {
                ...
                "overview_title": "Ikhtisar Transkrip",
                ...
                "content_description": "Transkrip berisi seluruh ucapan dari video. Karena ringkasan AI belum dapat dibuat saat ini, kami menyarankan:",
                "suggestions_intro": "Untuk informasi lebih detail, sebaiknya:",
                "suggestion_1": "Baca teks transkrip lengkap untuk mendapatkan informasi detail",
                "suggestion_2": "Perhatikan paragraf penting yang ditandai dengan timestamp",
                "suggestion_3": "Ambil poin utama dan kesimpulan secara manual",
                "recommendations": "Rekomendasi",
                "recommendation_1": "Konfigurasikan OpenAI API key untuk fitur ringkasan yang lebih baik",
                "recommendation_2": "Atau gunakan layanan AI lain untuk meringkas teks",
                "fallback_disclaimer": "Ini adalah ringkasan fallback yang dibuat otomatis"
            },
            "zh": {
                "notice": "注意",
